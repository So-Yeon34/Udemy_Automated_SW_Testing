...
class ItemTest(BaseTest):
    def setUp(self):
        # Super class
        # super() is mainly used in inheritance to reuse common initialization
        # or functionality from a parent class.
        ...
        with self.app() as client:
            with self.app_context():
                ...
                self.access_token = f'JWT {auth_token}' # Save auth_token property
