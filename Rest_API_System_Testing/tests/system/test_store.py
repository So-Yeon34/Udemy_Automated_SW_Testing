    ...
    def test_create_duplicate_store(self):
        with self.app() as client:
            with self.app_context():
                ...
                # 400 → "Bad Request" – used when the client sends an invalid request.
                self.assertEqual(resp.status_code, 400)

    # 200 is not a user-defined value, but the standard HTTP status code for "OK".
    # In Flask, if you don't explicitly set a status code in the response,
    # it defaults to 200 automatically.
